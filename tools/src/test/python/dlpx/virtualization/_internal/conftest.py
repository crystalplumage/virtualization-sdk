...
def plugin_config_content(plugin_id, plugin_name, external_version, language,
                          ...
                          start_hooks_run_during_enable, lua_name,
                          minimum_lua_version):
    """
    ...
    if start_hooks_run_during_enable:
        config['startHooksRunDuringEnable'] = start_hooks_run_during_enable
...
@pytest.fixture
def start_hooks_run_during_enable():
    return False
...
def basic_artifact_content(engine_api, virtual_source_definition,
    ...
    artifact = {
        ...
        'startHooksRunDuringEnable': False,
